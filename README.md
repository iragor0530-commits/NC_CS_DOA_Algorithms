...
1. Abeida, H., & Delmas, J. P. (2006). MUSIC-like estimation of direction of arrival for noncircular sources. *IEEE Transactions on Signal Processing*, 54(7), 2678–2690.
2. Charge, P., Wang, Y., & Saillard, J. (2001). A non-circular sources direction finding method using polynomial rooting. *Signal Processing*, 81(8), 1765–1770.
...
4. Wipf, D. P., & Rao, B. D. (2004). Sparse Bayesian learning for basis selection. *IEEE Transactions on Signal Processing*, 52(8), 2153–2164.
